...
/*
3/24/2022
Modified version of https://github.com/adamsoffer/next-apollo/blob/master/src/withApollo.tsx

Renamed withApollo -> createWithApollo
Exported globalApolloClient (so i can mess with the cache)
*/

// On the client, we store the Apollo Client in the following variable.
// This prevents the client from reinitializing between page transitions.
export let globalApolloClient: ApolloClient<NormalizedCacheObject> | null =
    null;
